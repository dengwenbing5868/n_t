...
def embedding_lookup(input_ids,
  ...
  if input_ids.shape.ndims == 2:     #最低维扩维 [batch_size,seq_length,1]
...
def transformer_model(input_tensor,
  ...
  attention_head_size = int(hidden_size / num_attention_heads)  # 768 / 12 = 64
  input_shape = get_shape_list(input_tensor, expected_rank=3)
  batch_size = input_shape[0]
  seq_length = input_shape[1]
  ...
  # help the optimizer.
  # 这里官方说为了避免来回升降维(2D到3D，3D到2D)，所以直接先变形为2D，
  # 最后再恢复成3D[batch_size * seq_length, hidden_size]
